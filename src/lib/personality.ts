...
// ============================================================================
// Описание уровней для UI/логирования
// ============================================================================
export const DISAGREEMENT_LABELS_RU: Record<DisagreementLevel, string> = {
  execute: 'согласна',
  reluctant: 'неохотно',
  counterOffer: 'альтернатива',
  principledRefusal: 'принципиальный отказ',
  ethicalBlock: 'этический блок',
};
